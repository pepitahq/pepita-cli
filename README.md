...
| `create <name> [--allow-embedding] [--block-ai-crawlers] [--from <dir>]` | Create a new site (optionally seeded from a local folder). Embedding starts denied and AI visibility on — both changeable later in Settings → Advanced |
